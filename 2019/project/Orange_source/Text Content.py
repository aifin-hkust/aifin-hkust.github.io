# -*- coding: utf-8 -*-
"""
Created on Fri May 10 16:29:52 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 24 19:41:52 2019
...
class Weibo:
    cookie = {"Cookie": "_T_WM=69571174976; SCF=Aoz0kRBjqR5nxUXZQ7chDj6aZ7ExrbQUwlJ3M80Knk-r-O7L64PaBNETLjs_EYJskhm_DMfc-SDtEc_CJNVtIR0.; WEIBOCN_WM=3349; H5_wentry=H5; backURL=https%3A%2F%2Fm.weibo.cn%2F; ALF=1558985574; SUB=_2A25xwN9RDeRhGeFP61AQ-SzLyDmIHXVTSuEZrDV6PUJbkdBeLW_gkW1NQS_KLFYV4jjH1WuhNJ3WCmvkZpaPb-n2; SUHB=02Mvix94yQYvsK; SSOLoginState=1556393729; MLOGIN=1; XSRF-TOKEN=39b806; WEIBOCN_FROM=1110006030; M_WEIBOCN_PARAMS=luicode%3D20000174%26uicode%3D20000174"}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        user_id = 5744693531  # 可以改成任意合法的用户id（爬虫的微博id除外）
        ...
        if wb.weibo_content:
            ...
            #find top 10
            up_num1=wb.up_num.copy()
            retweet_num1=wb.retweet_num.copy()
            comment_num1=wb.comment_num.copy()
            up_num1.sort(reverse=True)
            retweet_num1.sort(reverse=True)
            comment_num1.sort(reverse=True)
            for i in range(10):
                print('the top %d weibo in terms of up numbers is' %(i+1))
                print(
                "===========================================================================")
                index1=wb.up_num.index(up_num1[i])
                print(wb.weibo_content[index1])
                print('the corresponding up number is %d' %up_num1[i])
                print(
                "===========================================================================")
                print('the top %d weibo in terms of retweet numbers is' %(i+1))
                print(
                "===========================================================================")
                index2=wb.retweet_num.index(retweet_num1[i])
                print(wb.weibo_content[index2])
                print('the corresponding retweet number is %d' %retweet_num1[i])
                print(
                "===========================================================================")
                print('the top %d weibo in terms of comment numbers is' %(i+1))
                print(
                "===========================================================================")
                index3=wb.comment_num.index(comment_num1[i])
                print(wb.weibo_content[index3])
                print('the corresponding comment number is %d' %comment_num1[i])
                print(
                "===========================================================================")
    except Exception as e:
        print("Error: ", e)
